 ...
 * @author rgalo
 */
public class AttendBreakGUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblTitle.setText("Attended Break Detentions");
        ...
        btnDelete.setText("Delete this detention");
        ...
        jLayeredPane1Layout.setHorizontalGroup(
            ...
            .addGroup(jLayeredPane1Layout.createSequentialGroup()
                ...
                .addGroup(jLayeredPane1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(lblDescriptor, javax.swing.GroupLayout.DEFAULT_SIZE, 323, Short.MAX_VALUE)
        ...
        lblDescriptor4.setText("Details of the detentions for today:");
        ...
        lblDescriptor1.setText("Learners who did not attend their Break detention:");
    ...
    private void btnSaveAttendancesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveAttendancesActionPerformed
        ...
        for (Learner n : absentLearners) {
            String sqlMissed = "INSERT INTO tblDetention(LearnerID, OffenceID, OffenceDate, FridayDetention, Comment, Attended) \n"
                    + "SELECT TOP 1 LearnerID, 4, NOW(), FALSE, 'Missed BD (auto)', FALSE FROM tblLearner \n"
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        String sqlStatement = "DELETE *\n"
                + "FROM tblDetention\n"
                + "WHERE DetentionID IN (\n"
                + "SELECT TOP 1 DetentionID\n"
                + "FROM tblDetention, tblLearner \n"
                + "WHERE FName LIKE '" + fName + "'\n"
                + "AND SName LIKE '" + sName + "'\n"
                + "AND Grade LIKE '" + grade + "'\n"
                + "AND tblDetention.LearnerID = tblLearner.LearnerID\n"
                + "AND Attended = FALSE);";
        int update = DatabaseDriver.update(sqlStatement);
